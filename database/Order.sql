-- 创建订单表 Order
CREATE TABLE [Order] (
    OrderID CHAR(15) PRIMARY KEY,               -- 主键：订单编号 (15位, 符合新规则)
    StudentID CHAR(12) NOT NULL,                -- 外键：学生编号
    MerchantID CHAR(5) NOT NULL,                -- 外键：档口编号
    OrderTime DATETIME NOT NULL,                -- 下单时间
    TotalAmount DECIMAL(10, 2) NOT NULL,        -- 总金额
    Status NVARCHAR(10) CHECK (Status IN ('待支付', '已完成')) NOT NULL -- 订单状态 
    FOREIGN KEY (StudentID) REFERENCES Student(StudentID),
    FOREIGN KEY (MerchantID) REFERENCES Merchant(MerchantID)
);

INSERT INTO [Order] (OrderID, StudentID, MerchantID, OrderTime, TotalAmount, Status) VALUES  
('011012511030001', '202411040101', '01101', '2025-11-03 12:05:00', 18.00, N'已完成'), 
...
('012012511030020', '202411040305', '01201', '2025-11-03 18:50:00', 16.00, N'已完成');